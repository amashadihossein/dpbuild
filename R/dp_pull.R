#' @title Pull data product project from a remote repo
#' @description This command pulls data product project from a remote repo
...
dp_pull <- function(remote_url, branch,  verbose = F){
  ...
  repo <- tryCatch({
    git2r::pull(repo = project_path, local_path = project_path, branch = branch,
